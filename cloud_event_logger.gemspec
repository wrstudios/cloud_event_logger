...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "initiating repo, will add asap Set to 'http://mygemserver.com'"

    spec.metadata["homepage_uri"] = spec.homepage
    spec.metadata["source_code_uri"] = "initiating repo, will add asap Put your gem's public repo URL here."
    spec.metadata["changelog_uri"] = "initiating repo, will add asap Put your gem's CHANGELOG.md URL here."
  else
